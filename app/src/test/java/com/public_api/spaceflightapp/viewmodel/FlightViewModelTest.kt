package com.public_api.spaceflightapp.viewmodel

import androidx.arch.core.executor.testing.InstantTaskExecutorRule
import androidx.lifecycle.Observer
import com.public_api.chucknorrisapp.util.CoroutineTestRule
import com.public_api.chucknorrisapp.util.LifeCycleTestOwner
import com.public_api.spaceflightapp.repository.FlightRepository
import com.public_api.spaceflightapp.util.LoadingState
...
class FlightViewModelTest {
    ...
    fun whenGetFlightData_thenGetFlightsCalled(){
        coroutineTestRule.testDispatcher.runBlockingTest {
            ...
            // Then
            Mockito.verify(flightRepository, Mockito.times(1)).getFlights()
